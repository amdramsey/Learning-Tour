    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        registerBtn.setOnClickListener{
            ...
            if(!mailTxt.text.toString().trim().isEmpty()) {
                ...
                if(!nameTxt.text.toString().trim().isEmpty()) {

                    if(!passTxt.text.toString().trim().isEmpty()) {

                        if(!cpassTxt.text.toString().trim().isEmpty()) {

                            if(passTxt.text.toString().trim() == cpassTxt.text.toString().trim()) {register();clearAll()}else{passTxt.error = "Password doesn't match"}

                        } else {

                            cpassTxt.error = "Please confirm your password"
                    ...
                    nameTxt.error = "Please enter your name"
